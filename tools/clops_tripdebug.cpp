...
void printUsage() {
    std::cerr << "Usage: clops_tripdebug [options] <path_to_dashcam_folder>\n\n"
              << "Options:\n"
              ...
              << "Examples:\n"
              << "  clops_tripdebug /mnt/dashcam         (summary list)\n"
              << "  clops_tripdebug -T /mnt/dashcam      (full tree, all trips)\n"
              << "  clops_tripdebug -f /mnt/dashcam      (interactive drill-down)\n";
}
...
int main(int argc, char* argv[]) {
    ...
    for (int i = 1; i < argc; ++i) {
        ...
        if (arg == "-v" || arg == "--version") {
            std::cout << APP_NAME << " clops_tripdebug v" << APP_VERSION << "\n";
            return 0;
        }
    ...
    std::cout << "Exiting clops_tripdebug.\n";
    return 0;
}
// SN: 00112
