# CamClops — Original Project Brief (Historical)

> **Superseded.** This document is the original session-bootstrap brief from the
> QuadEye/early-CamClops era (v0.6.0, ~2026-02). The authoritative session context
> is now **CLAUDE.md** in the project root. Content below is preserved for historical
> reference only — many specifics (config paths, file layout, CLI flags, manifest
> schema) have changed significantly.
