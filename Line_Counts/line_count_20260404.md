# PathMux Line Count — 2026-04-04

## Grand Total: 23,041 lines

| Category | Lines |
|---|---|
| C++ source (`.cpp`) | 13,757 |
| C++ headers (`.hpp` / `.h`) | 2,524 |
| Markdown (`.md`) | 4,500 |
| `CMakeLists.txt` | 423 |
| Man pages (`.1`) | 1,837 |
| **Total** | **23,041** |
...
| File | Lines |
|---|---|
| `gui/TripBuildDialog.cpp` | 354 |
| `gui/BuildProgressDialog.cpp` | 340 |
| `gui/ManifestPanel.cpp` | 236 |
| `gui/TripGridPanel.cpp` | 220 |
| `gui/TripPropertiesDialog.cpp` | 202 |
