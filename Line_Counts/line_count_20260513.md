# PathMux Line Count — 2026-05-13

## Grand Total: 43,715 lines

| Category | Lines |
|---|---|
| C++ source (`.cpp`) | 24,771 |
| C++ headers (`.hpp` / `.h`) | 3,991 |
| Python scripts (`.py`) | 6,215 |
| Markdown (`.md`) | 5,825 |
| `CMakeLists.txt` | 734 |
| Man pages (`.1`) | 2,179 |
| **Total** | **43,715** |
...
| `gui/JobQueue.cpp` | 1,011 |
| `gui/SettingsDialog.cpp` | 717 |
| `gui/BuildProgressDialog.cpp` | 648 |
| `gui/JobQueuePanel.cpp` | 551 |
...
| File | Lines |
|---|---|
| `lib/config_manager.cpp` | 1,915 |
| `lib/gps_export.cpp` | 687 |
| `lib/trip_detection.cpp` | 522 |
| `lib/config_manager.hpp` | 387 |
