# PathMux Line Count — 2026-05-04

## Grand Total: 36,768 lines

| Category | Lines |
|---|---|
| C++ source (`.cpp`) | 22,701 |
| C++ headers (`.hpp` / `.h`) | 3,655 |
| Python scripts (`.py`) | 2,887 |
| Markdown (`.md`) | 4,970 |
| `CMakeLists.txt` | 697 |
| Man pages (`.1`) | 1,858 |
| **Total** | **36,768** |
...
| File | Lines |
|---|---|
| `gui/TripPropertiesDialog.cpp` | 1,805 |
...
| `gui/TripPropertiesDialog.h` | 138 |
| `gui/main.cpp` | 129 |
...
| `scripts/pm_dashboard.py` | 792 |
| `scripts/pm_sync_analyze.py` | 626 |
| `scripts/pm_maprender.py` | 548 |
