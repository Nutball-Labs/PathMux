# PathMux Line Count — 2026-04-05

## Grand Total: 23,472 lines

| Category | Lines |
|---|---|
| C++ source (`.cpp`) | 14,027 |
| C++ headers (`.hpp` / `.h`) | 2,542 |
| Markdown (`.md`) | 4,524 |
| `CMakeLists.txt` | 542 |
| Man pages (`.1`) | 1,837 |
| **Total** | **23,472** |
...
| File | Lines |
|---|---|
| `gui/BuildProgressDialog.cpp` | 523 |
| `gui/TripBuildDialog.cpp` | 355 |
| `gui/ManifestPanel.cpp` | 254 |
| `gui/TripGridPanel.cpp` | 220 |
