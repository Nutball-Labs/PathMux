# PathMux Line Count — 2026-04-07

## Grand Total: 25,272 lines

| Category | Lines |
|---|---|
| C++ source (`.cpp`) | 15,439 |
| C++ headers (`.hpp` / `.h`) | 2,872 |
| Markdown (`.md`) | 4,563 |
| `CMakeLists.txt` | 561 |
| Man pages (`.1`) | 1,837 |
| **Total** | **25,272** |
...
| File | Lines |
|---|---|
| `lib/config_manager.cpp` | 1,433 |
| `lib/gps_export.cpp` | 461 |
| `lib/trip_detection.cpp` | 434 |
| `lib/config_manager.hpp` | 355 |
