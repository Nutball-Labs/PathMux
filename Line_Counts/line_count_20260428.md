# PathMux Line Count — 2026-04-28

## Grand Total: 32,313 lines

| Category | Lines |
|---|---|
| C++ source (`.cpp`) | 21,244 |
| C++ headers (`.hpp` / `.h`) | 3,571 |
| Markdown (`.md`) | 4,969 |
| `CMakeLists.txt` | 671 |
| Man pages (`.1`) | 1,858 |
| **Total** | **32,313** |
...
| File | Lines |
|---|---|
| `gui/TripPropertiesDialog.cpp` | 1,509 |
| `gui/TripBuildDialog.cpp` | 1,197 |
| `gui/SettingsDialog.cpp` | 702 |
| `gui/BuildProgressDialog.cpp` | 650 |
| `gui/BuildAllDialog.cpp` | 456 |
| `gui/SetupWizard.cpp` | 432 |
| `gui/DangerousDialog.cpp` | 417 |
| `gui/MainWindow.cpp` | 388 |
| `gui/TripTile.cpp` | 367 |
| `gui/MapProgressDialog.cpp` | 359 |
...
| `gui/TripPropertiesDialog.h` | 126 |
| `gui/SetupWizard.h` | 117 |
| `gui/SettingsDialog.h` | 112 |
| `gui/TripBuildDialog.h` | 103 |
| `gui/main.cpp` | 99 |
...
| File | Lines |
|---|---|
| `tools/pm_probe.cpp` | 2,124 |
| `tools/pm_gpsinfo.cpp` | 727 |
| `tools/pm_gpsexport.cpp` | 391 |
